...
eval("Promise.all(/*! import() */[__webpack_require__.e(\"webpack_sharing_consume_default_react_react\"), __webpack_require__.e(\"src_App_jsx\")]).then(__webpack_require__.bind(__webpack_require__, /*! ./App */ \"./src/App.jsx\"));\n\n//# sourceURL=webpack://host/./src/index.js?");

/***/ }),

/***/ "webpack/container/reference/nav":
/*!****************************************************************************************************************************!*\
  !*** external "nav@https://cdn.jsdelivr.net/gh/Mogget24/module-federation-state-management/redux/nav/dist/remoteEntry.js" ***!
  \****************************************************************************************************************************/
...
module.exports = new Promise((resolve, reject) => {
	if(typeof nav !== "undefined") return resolve();
	__webpack_require__.l("https://cdn.jsdelivr.net/gh/Mogget24/module-federation-state-management/redux/nav/dist/remoteEntry.js", (event) => {
		if(typeof nav !== "undefined") return resolve();
...
/*!********************************************************************************************************************************!*\
  !*** external "store@https://cdn.jsdelivr.net/gh/Mogget24/module-federation-state-management/redux/store/dist/remoteEntry.js" ***!
  \********************************************************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = new Promise((resolve, reject) => {
	...
	__webpack_require__.l("https://cdn.jsdelivr.net/gh/Mogget24/module-federation-state-management/redux/store/dist/remoteEntry.js", (event) => {
		if(typeof store !== "undefined") return resolve();
		var errorType = event && (event.type === 'load' ? 'missing' : event.type);
		var realSrc = event && event.target && event.target.src;
		__webpack_error__.message = 'Loading script failed.\n(' + errorType + ': ' + realSrc + ')';
...
/******/ 					initExternal("webpack/container/reference/store");
/******/ 				}
/******/ 				break;
/******/ 			}
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "https://cdn.jsdelivr.net/gh/Mogget24/module-federation-state-management/redux/host/dist/";
/******/ 	})();
/******/ 	
